...
/**
 * Servlet implementation class AjaxAdminReplyController
 */
@WebServlet("/adreply.co")
...
//		
//		System.out.println("controller cont : "+ contNo);
//		System.out.println("controller reply : "+adminReply);
//		if(result > 0) {
//			request.getSession().setAttribute("alertMsg", "답변이 등록되었습니다");
//			response.sendRedirect(request.getContextPath()+"/adreply.co?cno="+ contNo);
//		}else {
//			request.setAttribute("errorMsg", "답변 등록 실패");
//			request.getRequestDispatcher("views/common/errorPage.jsp").forward(request, response);
//		}
		
		request.getRequestDispatcher("views/AdminContact/AdminContactReply.jsp").forward(request, response);
