...
public class OrderListMyPageController extends HttpServlet {
   private static final long serialVersionUID = 1L;
     ...
     */
    public OrderListMyPageController() {
        super();
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //--------------- 페이징 처리 -----------------------
            ...
            // * listCount : 총 게시글 갯수
            listCount = new OrderService().selectListCount(userNo);
            ...
            // 1. 페이징바를 만들때 필요한 객체
            PageInfo1 pi = new PageInfo1(listCount, currentPage, pageLimit, boardLimit, maxPage, startPage, endPage);
            ...
            ArrayList<OrderListMyPage> list = new OrderService().selectListMyPage(pi, userNo);
            ...
            if(userNo ==1) {
               ...
               request.getRequestDispatcher("views/order/userOrderList.jsp").forward(request, response);
            }
