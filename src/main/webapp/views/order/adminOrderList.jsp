<%@ page import="java.util.ArrayList, com.kh.orderMyPage.model.vo.OrderListMyPage, com.kh.common.model.vo.PageInfo1, java.sql.Date" %>
        ...
        <table class="contact_tb">
            <thead>
                <tr>
                    ...
                    <th width="300">상품명</th>
                    <th width="140">회원 아이디</th>
                    <th width="100">주문날짜</th>
                    <th width="100">배송상황</th>
                    <th width="100">취소신청</th>
                </tr>
            </thead>
            <tbody>
            <tbody>
	...
	<script>
		$(function(){
			$(".contact_tb>tbody>tr").click(function(){
				location.href="<%= contextPath %>/detail.od?ono="+$(this).children().eq(0).text();
			})
		});
	</script>
