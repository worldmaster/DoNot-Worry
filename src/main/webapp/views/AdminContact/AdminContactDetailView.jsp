...
<body>
	...
	<div class="content">
	<br><br><br>
	<form action="<%=request.getContextPath()%>/adreply.co" method="post">
	 ...
	 <tbody>
		...
		<table class="table table-striped" id="admin-reply-enroll">
			<tr>
				...
				<td>
					<textarea class="form-control" name="adminReply" placeholder="관리자 답변" rows="5" cols="120" style="resize: none;"><%= ac.getAdminReply() == null ? "" : ac.getAdminReply() %></textarea> 
				</td>
			</tr>
		</table>
		...
		<input type="submit" class="btn btn-primary"  value="등록" style="background-color: #fafafa; border:1px solid #dddddd; color: black;">
		
<%-- 		<a href="<%=request.getContextPath() %>/adreply.co?cno=<%=ac.getContNo()%>" class="btn btn-primary" style="background-color: #fafafa; border:1px solid #dddddd; color: black;">등록</a> --%>
